 ...
 */
const Semaphore = require('./simple');
...
async function checkSingleStepProducer() {
...
async function checkEfficientProducer() {
    console.log(`\n\n[Efficient producer]`);
    const workers2 = [
...
// checkSingleStepProducer().then(() => console.log('single: done!'), err => console.error(err));
// checkEfficientProducer().then(() => console.log('Efficient: done!'), err => console.error(err));
// checkRejection().then(() => console.log('rejection: done!'), err => console.error(err));