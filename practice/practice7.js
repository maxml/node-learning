function exSimpleRegexp() {
  ...
  console.log(str.match(/we/i)); // Home work
...
3rd place: Eeyore`;
  ...
  console.log("Hello, Java1!".match(/\bJava\b/));
  ...
  console.log("Chapter 5.1".match(regStr));
}
// exSimpleRegexp();
...
function exSetRange() {
  ...
  console.log("Exception 0xAF".match(/0x[0-9A-F][0-9A-F]/g));
  ...
  console.log("I'm not 12, but 345678 years old".match(/\d{1,3}/g));
}
// exSetRange();
...
function exQuantifiers() {
  ...
  console.log("100 10 1 0 00".match(/\d0*/g)); // zero or more
  ...
  regexp = "";
  str = "color:#121212; background-color:#AA00ef bad-colors:f#fddee #fd2";
